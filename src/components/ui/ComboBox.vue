      ...
      <ComboboxViewport class="scroll-auto p-[5px]">
        ...
        <ComboboxGroup>
          <ComboboxItem
            ...
            :key="index"
            class="relative flex h-[25px] select-none items-center rounded-[3px] pl-[25px] pr-[35px] text-[13px] leading-none text-purple data-[disabled]:pointer-events-none data-[highlighted]:bg-purple/80 data-[disabled]:text-mauve8 data-[highlighted]:text-grass1 data-[highlighted]:outline-none md:text-base"
            :value="option"
          >
